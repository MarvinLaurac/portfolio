...
export default function NoticeBanner() {
  return (
    <>
      {/* Spacer pour compenser la barre fixe + le header */}
      <div className="h-[33px] shrink-0" />
      {/* Barre fixée au top, z-index au-dessus du header (z-50) */}
      <div className="fixed top-0 left-0 right-0 z-[60] bg-[#F0EDE8]">
        <div className="flex items-center justify-center gap-1.5 py-2 px-4">
          ...
          <p className="text-[11px] sm:text-[12px] text-[#1a1a1a]/40 truncate">
